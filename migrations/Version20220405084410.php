 ...
 */
final class Version20220405084410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parser_tasks ADD last_process_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parser_tasks DROP last_process_at, CHANGE contract contract VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE last_transaction_hash last_transaction_hash VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
